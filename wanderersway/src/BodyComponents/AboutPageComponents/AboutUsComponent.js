    ...
    return(
        <div className="AboutUs">
            <div className='AboutContent'>
                <span>
                    <h1>About Us</h1>
                <p className="AboutUsPara">We are one of the leading trip advisor and trip planner. We give you advise based on  your chosen  travel time, duration and  destination.
